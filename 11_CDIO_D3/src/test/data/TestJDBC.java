...
class TestJDBC {
     ...
     */
    @DisplayName("SQLOperatorDAO")
    @Test
    private void testSQLOperatorDAO() {
     ...
     */
    @DisplayName("SQLProductBatchComponentDAO")
    @Test
    private void testSQLProductBatchComponentDAO() {
     ...
     */
    @DisplayName("SQLProductBatchDAO")
    @Test
    private void testSQLProductBatchDAO() {
     ...
     */
    @DisplayName("SQLRaavareBatchDAO")
    @Test
    private void testSQLRaavareBatchDAO() {
     ...
     */
    @DisplayName("SQLRaavareDAO")
    @Test
    private void testSQLRaavareDAO() {
     ...
     */
    @DisplayName("SQLReceptComponentDAO")
    @Test
    private void testSQLReceptComponentDAO() {
     ...
     */
    @DisplayName("SQLReceptDAO")
    @Test
    private void testSQLReceptDAO() {
     ...
     */
    @DisplayName("SQLRoleDAO")
    @Test
    private void testSQLRoleDAO() {
